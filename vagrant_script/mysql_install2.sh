...
-O /${STORAGE}/galera-3_25.3.16-1jessie_amd64.deb
dpkg -i --force-all /${STORAGE}/galera-3_25.3.16-1jessie_amd64.deb
...
if [ "$1" ]; then
  ...
  tar xf "$1" -C ${STORAGE}
  dpkg -i --force-all /${STORAGE}/libpercona* /${STORAGE}/percona*
fi
